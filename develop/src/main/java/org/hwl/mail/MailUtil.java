...
public class MailUtil {
	...
	public static void main(String[] args) {
		for(int i=0;i<10;i++){
			...
			mail.setSender("myhaifeng@163.com");
			mail.setReceiver("327764115@qq.com"); // 接收人
			
			mail.setUsername("myhaifeng@163.com"); // 登录账号,一般都是和邮箱名一样吧
			mail.setPassword("haifeng123"); // 发件人邮箱的登录密码
			mail.setSubject("xxxxxxxxx");
			mail.setMessage("6666");
